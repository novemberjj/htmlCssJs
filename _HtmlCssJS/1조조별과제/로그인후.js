...
<ul class="icon">
    <!-- 구독, 이용자한마디, 공유, 날짜 -->
    <li><button type="button" class="subscribeBtn" id="0" onclick="subs(this);">
...
<div class="article4_0">
    ...
    <div class="lank_0">
        ...
        <div class="artice4_0-img">
            <ul>
                <li><a href="https://www.bloter.net/news/articleView.html?idxno=600916" target="_blank"><img src="/1조조별과제/image/0번기사사진/arti0_img3.jpg" alt="" width="80px" height="50px"></a></li>
                <li><a href="https://www.bloter.net/news/articleView.html?idxno=601007" target="_blank"><img src="/1조조별과제/image/0번기사사진/arti0_img4.jpg" alt="" width="80px" height="50px"></a></li>
                <li><a href="https://www.bloter.net/news/articleView.html?idxno=600914" target="_blank"><img src="/1조조별과제/image/0번기사사진/arti0_img5.jpg" alt="" width="80px" height="50px"></a></li>
            </ul>
    ...
    <ul class="icon">
        <!-- 구독, 이용자한마디, 공유, 날짜 -->
        <li><button type="button" class="subscribeBtn" id="1" onclick="subs(this);">
            <span class="material-symbols-outlined">
                done
                </span>
            구독하기</button></li>
...
<div class="wrap">
        <div class="article1_1">
            ...
            <a href="http://www.newsprime.co.kr/news/article/?no=600045" target="_blank">
                <div class="arti1-img1">
                    <img src="/1조조별과제/image/1번기사사진/arti1_img2.jpg" alt="" width="134px" height="134px">
                    <p>
            ...
            <a href="http://www.newsprime.co.kr/news/article/?no=600028" target="_blank">
                <div class="arti1-img2">
                    <img src="/1조조별과제/image/1번기사사진/arti1_img3.jpg" alt="" width="134px" height="134px">
                    <p>
            ...
            <a href="http://www.newsprime.co.kr/news/article/?no=599998" target="_blank">
                <div class="arti1-img3">
                    <img src="/1조조별과제/image/1번기사사진/arti1_img4.jpg" alt="" width="134px" height="134px">
                    <p>
    ...
    <ul class="icon">
        <!-- 구독, 이용자한마디, 공유, 날짜 -->
        <li><button type="button" class="subscribeBtn" id="2" onclick="subs(this);">
            <span class="material-symbols-outlined">
                done
                </span>
            구독하기</button></li>
...
<section>
    ...
    <div class="article4_2">
        ...
        <div class="lank_2">
            ...
            <div class="artice4_2-img">
                <ul>
                    <br>
                    <li><a href="https://it.chosun.com/site/data/html_dir/2023/04/03/2023040302321.html" target='blank'><img src="/image/2번기사/it조선기사사진.jpeg" alt="1" width="80px" height="50px"></a></li>
                    <br>
                    <li><a href="https://it.chosun.com/site/data/html_dir/2023/04/27/2023042702683.html?utm_source=naver&utm_medium=newsstand&utm_campaign=it" target='blank'><img src="/image/2번기사/it조선기사사진2.jpeg" alt="1" width="80px" height="50px"></a></li>
                </ul>
    ...
    <ul class="icon">
        <!-- 구독, 이용자한마디, 공유, 날짜 -->
        <li><button type="button" class="subscribeBtn" id="3" onclick="subs(this);">
            <span class="material-symbols-outlined">
                done
                </span>
            구독하기</button></li>
...
<section>
    ...
    <div class="article4_3">
        ...
        <div class="lank_3">
            ...
            <div class="artice4_3-img">
                <ul>
                    <li><a href="https://it.donga.com/103791/" target='_blank'><img src="/image/3번기사/이츠동아기사사진4.jpg" alt="" width="80px" height="50px"></a></li>
                    <li><a href="https://it.donga.com/103787/" target='_blank'><img src="/image/3번기사/이츠동아기사사진5.jpg" alt="" width="80px" height="50px"></a></li>
                </ul>
    ...
    <ul class="icon">
        <!-- 구독, 이용자한마디, 공유, 날짜 -->
        <li><button type="button" class="subscribeBtn" id="4" onclick="subs(this);">
            <span class="material-symbols-outlined">
                done
                </span>
            구독하기</button></li>
...
<section>
    ...
    <div class="article4_4">
        ...
        <div class="lank_4">
            ...
            <div class="artice4_4-img">
                <ul>
                    <li><a href="https://www.yonhapnewstv.co.kr/news/MYH20230429012000641" target='_blank'><img src="/1조조별과제/image/4번기사사진/004.jpg" alt="" width="80px" height="50px"></a></li>
                    <li><a href="https://www.yonhapnewstv.co.kr/news/MYH20230429007900641" target='_blank'><img src="/1조조별과제/image/4번기사사진/005.jpg" alt="" width="80px" height="50px"></a></li>
                    <li><a href="" target='_blank'><img src="/1조조별과제/image/4번기사사진/006.jpg" alt="" width="80px" height="50px"></a></li>
                </ul>
    ...
    <ul class="icon">
        <!-- 구독, 이용자한마디, 공유, 날짜 -->
        <li><button type="button" class="subscribeBtn" id="5" onclick="subs(this);">
            <span class="material-symbols-outlined">
                done
                </span>
            구독하기</button></li>
...
<section>
    ...
    <div class="article4_5">
        ...
        <div class="lank_5">
            ...
            <div class="artice4_5-img">
                <ul>
                    <li><a href="https://biz.sbs.co.kr/article/20000115785" target='_blank'><img src="/1조조별과제/image/5번기사사진/004.jpg" alt="" width="80px" height="50px"></a></li>
                    <li><a href="https://biz.sbs.co.kr/article/20000115744" target='_blank'><img src="/1조조별과제/image/5번기사사진/005.jpg" alt="" width="80px" height="50px"></a></li>
                    <li><a href="https://biz.sbs.co.kr/article/20000115743" target='_blank'><img src="/1조조별과제/image/5번기사사진/006.jpg" alt="" width="80px" height="50px"></a></li>
                </ul>
        ...
        <ul class="icon">
            <!-- 구독, 이용자한마디, 공유, 날짜 -->
            <li><button type="button" class="subscribeBtn" id="6" onclick="subs(this);">
                <span class="material-symbols-outlined">
                    done
                    </span>
                구독하기</button></li>
        ...
        <div class="article4_7">
            ...
            <div class="lank_7">
                ...
                <div class="artice4_7-img">
                    <ul>
                        <li><a href="https://www.bloter.net/news/articleView.html?idxno=600916" target="_blank"><img src="/1조조별과제/image/7번기사사진/뉴진스6.jpg" alt="" width="80px" height="50px"></a></li>
                        <li><a href="https://www.bloter.net/news/articleView.html?idxno=601007" target="_blank"><img src="/1조조별과제/image/7번기사사진/뉴진스7.jpg" alt="" width="80px" height="50px"></a></li>
                        <li><a href="https://www.bloter.net/news/articleView.html?idxno=600914" target="_blank"><img src="/1조조별과제/image/7번기사사진/뉴진스8.jpg" alt="" width="80px" height="50px"></a></li>
                    </ul>
    ...
    <ul class="icon">
        <!-- 구독, 이용자한마디, 공유, 날짜 -->
        <li><button type="button" class="subscribeBtn" id="7" onclick="subs(this);">
            <span class="material-symbols-outlined">
                done
                </span>
            구독하기</button></li>
...
<section>
    ...
    <div class="article4_0">
        ...
        <div class="lank_0">
            ...
            <div class="artice4_0-img">
                <ul>
                    <li><a href="https://www.bloter.net/news/articleView.html?idxno=600916" target="_blank"><img src="/1조조별과제/image/6번기사사진/hot뉴스2.jpg " alt="" " width="80px" height="50px"></a></li>
                    <li><a href="https://www.bloter.net/news/articleView.html?idxno=601007" target="_blank"><img src="/1조조별과제/image/6번기사사진/hot뉴스1.jpg" alt="" width="80px" height="50px"></a></li>
                    <li><a href="https://www.bloter.net/news/articleView.html?idxno=600914" target="_blank"><img src="/1조조별과제/image/6번기사사진/hot뉴스3.jpg" alt="" width="80px" height="50px"></a></li>
                </ul>
...
document.querySelector('.gisa').style.animation = 'citycity 3s';
addStyle();
});
...
document.querySelector('.gisa').style.animation = 'citycity 3s';
    ...
    function subs(e){
        count++;
        console.log(e.id);
        // const btnStr=JSON.stringify(e);
        // console.log(btnStr);
        
        
        if(count%2==1){
            swal('구독 완료', "", 'success');
            document.querySelector('.subscribeBtn').style.backgroundColor="white";
            document.querySelector('.subscribeBtn').style.color="black";
            document.querySelector('.subscribeBtn').style.border="1px solid gray";
            document.querySelector('.subscribeBtn').style.borderRadius="2px 2x 2px 2px";
            document.querySelector('.subscribeBtn').innerHTML=`<span class="material-symbols-outlined">
                close
                </span> 구독해지`;
                
            }else{
            swal('해지 완료', "", 'success');
            document.querySelector('.subscribeBtn').style.backgroundColor="";
            document.querySelector('.subscribeBtn').style.color="";
            document.querySelector('.subscribeBtn').style.border="";
            document.querySelector('.subscribeBtn').style.borderRadius="";
            document.querySelector('.subscribeBtn').innerHTML=`  <span class="material-symbols-outlined">
            done
            </span> 구독하기`;
